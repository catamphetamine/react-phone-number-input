...
describe(`phone`, function()
{
	it(`should validate phone number`, function()
	{
		...
		validate('+1999123456', formats.PR).should.equal(false)
		validate('+19991234567', formats.PR).should.equal(false)
		validate('+17871234567', formats.PR).should.equal(true)
		validate('+19391234567', formats.PR).should.equal(true)
		validate('+1939123456', formats.PR).should.equal(false)
		validate('+193912345678', formats.PR).should.equal(false)
	...
	it(`should populate phone template`, function()
	{
		...
		populate_template('8 (AAA) xxx-xx-xx', '1').should.equal('8 (1  )')
		populate_template('8 (AAA) xxx-xx-xx', '12').should.equal('8 (12 )')
		populate_template('8 (AAA) xxx-xx-xx', '12345678').should.equal('8 (123) 456-78')
		populate_template('(0XXX) xxx-xx-xx', '123456789').should.equal('(0123) 456-78-9')
