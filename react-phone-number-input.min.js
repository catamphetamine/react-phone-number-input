...
var _formatter = __webpack_require__(53);

var _formatter2 = _interopRequireDefault(_formatter);

var _editor = __webpack_require__(52);
...
function edit_and_format(operation, input_text, phone_number_format, caret_position, selection, options) {
	...
	var digits = _edit_and_parse.digits;
	var digit_index = _edit_and_parse.digit_index;
	...
	if (phone_number_format) {
		...
		var phone = _format.phone;
		var caret = _format.caret;
...
var _editable = __webpack_require__(34);
...
var Phone_input = function (_React$Component) {
	...
	(0, _createClass3.default)(Phone_input, [{
		...
		value: function format_input_text(operation) {
			...
			var phone = _edit_and_format.phone;
			var caret = _edit_and_format.caret;
...
// }
//
function edit(value, caret_position, format, operation, selection) {
	...
	if (selection && (operation === 'Backspace' || operation === 'Delete')) {
		...
		return (0, _parser2.default)(value, caret_position, format, options);
	}

	var _parse = (0, _parser2.default)(value, caret_position, format, options);

	var digits = _parse.digits;
	var digit_index = _parse.digit_index;
...
Object.defineProperty(exports, 'format_local', {
	enumerable: true,
	get: function get() {
		return _phone.format_local;
	}
});
Object.defineProperty(exports, 'formatLocal', {
	enumerable: true,
	get: function get() {
		return _phone.format_local;
	}
...
Object.defineProperty(exports, 'edit_and_format', {
	enumerable: true,
	get: function get() {
		return _editable.edit_and_format;
	}
});
Object.defineProperty(exports, 'editAndFormat', {
	enumerable: true,
	get: function get() {
		return _editable.edit_and_format;
	}
});
Object.defineProperty(exports, 'parse_value', {
	enumerable: true,
	get: function get() {
		return _editable.parse_value;
	}
});
...
Object.defineProperty(exports, 'format_value', {
	enumerable: true,
	get: function get() {
		return _editable.format_value;
	}
});
