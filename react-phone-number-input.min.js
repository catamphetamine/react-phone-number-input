...
function format_international(value, format) {
	var number = local_to_international_style(format_local(value, format));
...
function edit_and_format(operation, input_text, phone_number_format, caret_position, selection, options) {
	...
	if (phone_number_format) {
		return (0, _formatter2.default)(digits, digit_index, phone_number_format);
	}
	...
	if (phone_number_format) {
		...
		var _format = (0, _formatter2.default)(_digits, _digit_index, phone_number_format, { international: true });
