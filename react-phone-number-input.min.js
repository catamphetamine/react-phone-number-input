	...
	(0, _createClass3.default)(Phone_input, [{
		...
		value: function render() {
			...
			return _react2.default.createElement('input', (0, _extends3.default)({}, rest, {
				type: 'tel',
				ref: 'input',
				value: (0, _phone.format_local)(value ? value.trim() : '', format, has_trunk_prefix),
		...
		value: function parse(value) {
			...
			var has_trunk_prefix = false;
			return (0, _phone.parse_plaintext_international)(value, format, has_trunk_prefix);
		}
...
function edit(value, caret_position, format) {
	...
	var caret_position_for_digit = function caret_position_for_digit(digit_index, digit_count, digits) {
		return _caret_position_for_digit(digit_index, digit_count, format, digits, options.has_trunk_prefix);
	};

	// Phone number digits (may be altered later)
	var digits = (0, _phone.local_phone_digits)(value, format, options.has_trunk_prefix);

	// How many are there digits in a valid local phone number
	// (including trunk prefix)
	var digits_in_phone_number = (0, _phone.digits_in_local_phone_number_template)(format, value, options.has_trunk_prefix);
	...
	if (options.backspace) {
		...
		if (options.selection) {
			...
			digits = (0, _phone.local_phone_digits)(value, format, options.has_trunk_prefix);
	...
	return { phone: (0, _phone.format_local)(digits, format, options.has_trunk_prefix), caret: caret_position };
}
...
function _caret_position_for_digit(digit_index, digit_count, format, digits, has_trunk_prefix) {
	...
	if (digit_index >= digit_count) {
		...
		return (0, _phone.index_in_template)(digit_count - 1, format, digits, has_trunk_prefix) + 1;
	}

	return (0, _phone.index_in_template)(digit_index, format, digits, has_trunk_prefix);
}
module.exports = exports['default'];
