...
})(this, function(__WEBPACK_EXTERNAL_MODULE_103__, __WEBPACK_EXTERNAL_MODULE_104__) {
...
var _country = __webpack_require__(32);
...
//
function parse_plaintext_international(formatted, format) {
	// The input digits
...
//
function template(format, value) {
...
//
function local_phone_digits(value, format) {
...
//
function format_local(value, format) {
...
//
function digits_in_local_phone_number_template(format, plaintext_local) {
...
//                  ^
//
function index_in_template(digit_index, format, digits) {
	var phone_template = template(format, digits);
...
function plaintext_international(plaintext, format) {
	if (!plaintext) {
		return '';
	}
...
//
function plaintext_local(plaintext, format) {
	if (!plaintext) {
		return '';
	}
...
var _phone = __webpack_require__(17);
	...
	(0, _createClass3.default)(Phone_input, [{
		...
		value: function render() {
			...
			return _react2.default.createElement('input', (0, _extends3.default)({}, rest, {
				type: 'tel',
				ref: 'input',
				value: (0, _phone.format_local)(value ? value.trim() : '', format),
		...
		value: function set_input_value(value, caret_position) {
			...
			if (onChange) {
				onChange((0, _phone.parse_plaintext_international)(value, format));
			}
		}
		...
		value: function on_blur(event) {
			...
			if (onBlur) {
				onBlur((0, _phone.parse_plaintext_international)(this.input_element().value, format));
			}
		}
...
function edit(value, caret_position, format) {
	...
	var digits = (0, _phone.local_phone_digits)(value, format);

	// How many are there digits in a valid local phone number
	// (including trunk prefix)
	var digits_in_phone_number = (0, _phone.digits_in_local_phone_number_template)(format, value);
	...
	if (options.backspace) {
		...
		if (options.selection) {
			...
			digits = (0, _phone.local_phone_digits)(value, format);
	...
	return { phone: (0, _phone.format_local)(digits, format), caret: caret_position };
}
...
function caret_position_for_digit(digit_index, digit_count, format, digits) {
	...
	if (digit_index >= digit_count) {
		...
		return (0, _phone.index_in_template)(digit_count - 1, format, digits) + 1;
	}

	return (0, _phone.index_in_template)(digit_index, format, digits);
}
module.exports = exports['default'];
...
Object.defineProperty(exports, 'phone_number_format', {
	enumerable: true,
	get: function get() {
		return _interopRequireDefault(_formats).default;
	}
});
Object.defineProperty(exports, 'phoneNumberFormat', {
	enumerable: true,
	get: function get() {
		return _interopRequireDefault(_formats).default;
	}
...
Object.defineProperty(exports, 'plaintext_local', {
	enumerable: true,
	get: function get() {
		return _phone.plaintext_local;
	}
});
Object.defineProperty(exports, 'plaintextLocal', {
	enumerable: true,
	get: function get() {
		return _phone.plaintext_local;
	}
});
Object.defineProperty(exports, 'plaintext_international', {
	enumerable: true,
	get: function get() {
		return _phone.plaintext_international;
	}
});
Object.defineProperty(exports, 'plaintextInternational', {
	enumerable: true,
	get: function get() {
		return _phone.plaintext_international;
	}
...
Object.defineProperty(exports, 'parse_phone_number', {
	enumerable: true,
	get: function get() {
		return _phone.parse_plaintext_international;
	}
});
...
Object.defineProperty(exports, 'country_from_locale', {
	enumerable: true,
	get: function get() {
		return _country.country_from_locale;
	}
});
Object.defineProperty(exports, 'countryFromLocale', {
	enumerable: true,
	get: function get() {
		return _country.country_from_locale;
	}
